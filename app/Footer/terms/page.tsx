    ...
    <Layout>
      <div className=" mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8 border-b pb-4">Terms and Conditions</h1>
          
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">1. Introduction</h2>
            <p className="text-gray-700 mb-4 dark:text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">2. User Responsibilities</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">3. Advertisement Posting</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">4. Violation Content Policy</h2>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li className="text-gray-700 dark:text-gray-300">a. Content that violates applicable laws or regulations.</li>
              ...
              <li className="text-gray-700 dark:text-gray-300">d. Misleading or fraudulent content.</li>
              <li className="text-gray-700 dark:text-gray-300">e. Content promoting illegal activities.</li>
              <li className="text-gray-700 dark:text-gray-300">f. Adult content or explicit material.</li>
              <li className="text-gray-700 dark:text-gray-300">g. Content that violates the privacy rights of individuals.</li>
            </ul>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">5. Data Protection and Privacy</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">6. Limitation of Liability</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">7. Miscellaneous</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">8. User Account</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">9. Third-Party Links</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">10. Indemnification</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">11. Severability</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4 dark:text-white">12. Contact Information</h2>
            <p className="text-gray-700 mb-2 leading-relaxed dark:text-gray-300">
              <strong>12.1.</strong> For any questions about these terms and
              conditions or other inquiries, you can contact us at{" "}
              <a href="mailto:contactus@klassifies.com" className="text-blue-600 hover:underline">
          ...
          <p className="text-gray-700 mt-8 leading-relaxed border-t pt-4 dark:text-gray-300">
