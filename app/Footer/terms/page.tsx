    ...
    <Layout>
      <div className=" mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="prose prose-sm sm:prose lg:prose-lg xl:prose-xl mx-auto">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">3. Advertisement Posting</h2>
            <p className="text-gray-700 mb-2 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">4. Violation Content Policy</h2>
            <p className="text-gray-700 mb-4 leading-relaxed">
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2">
              <li className="text-gray-700">a. Content that violates applicable laws or regulations.</li>
              ...
              <li className="text-gray-700">d. Misleading or fraudulent content.</li>
              <li className="text-gray-700">e. Content promoting illegal activities.</li>
              <li className="text-gray-700">f. Adult content or explicit material.</li>
              <li className="text-gray-700">g. Content that violates the privacy rights of individuals.</li>
            </ul>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">5. Data Protection and Privacy</h2>
            <p className="text-gray-700 mb-2 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">7. Miscellaneous</h2>
            <p className="text-gray-700 mb-2 leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">8. User Account</h2>
            <p className="text-gray-700 mb-2 leading-relaxed">
          ...
          <p className="text-gray-700 mt-8 leading-relaxed border-t pt-4">
