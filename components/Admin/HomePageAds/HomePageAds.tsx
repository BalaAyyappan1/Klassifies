    ...
    <div className="p-6 ">
      ...
      <div className="bg-white dark:bg-[#1e1e1e] p-6 rounded-lg shadow-md mb-8">
        ...
        <form onSubmit={uploadFiles} className="space-y-4">
          {/* Link input field */}
          <div className="mb-4">
            <label htmlFor="ad-link" className="block dark:text-white text-sm font-medium text-gray-700 mb-1">
              Ad Link
            </label>
            <input
              type="url"
              ...
              className="w-full p-2 border bg-[#333333] border-gray-300 rounded-md"
            />
          ...
          <button
            ...
            className="bg-blue-700 cursor-pointer text-white px-4 py-2 rounded disabled:bg-blue-600"
          >
